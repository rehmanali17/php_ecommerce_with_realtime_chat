...
<ul class="nav nav-fill nav-tabs" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="fill-tab-0" data-bs-toggle="tab" href="#fill-tabpanel-0" role="tab"
           aria-controls="fill-tabpanel-0" aria-selected="true"> Seller Products </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link active" id="fill-tab-1" data-bs-toggle="tab" href="#fill-tabpanel-1" role="tab"
...
<div class="tab-content pt-2" id="tab-content">
    ...
    <div class="tab-pane" id="fill-tabpanel-2" role="tabpanel" aria-labelledby="fill-tab-2">
                ...
                <div class="people-list" id="people-list">
                    <ul class="list">
                        ...
                        foreach ($rows as $row) {
                            ...
                            <li class="clearfix">
                                <div class="about">
                                    <div class="name" id="chatHistoryUser"
                                         data-id="<?php echo $row['id'] ?>"><?php echo $row['display_name'] ?></div>
                                    <div class="status">
        ...
        <?php } else { ?>
            <div class="container py-5">
                <div class="row">
                    <p class="alert alert-danger">No other users in the system</p>
                </div>
            </div>
        <?php } ?>
